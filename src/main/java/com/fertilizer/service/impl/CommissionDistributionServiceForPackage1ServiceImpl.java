...
@Service
public class CommissionDistributionServiceForPackage1ServiceImpl implements CommissionDistributionServiceForPackage1 {

	private static final Logger log = LoggerFactory
			.getLogger(CommissionDistributionServiceForPackage1ServiceImpl.class);
...
//		List<ProfitDistributionMasterSmallPackage> profitDistributions = profitDistributionRepositoryForSmallPackage.findAll();

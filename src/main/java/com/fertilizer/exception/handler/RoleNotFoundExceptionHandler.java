...
public class RoleNotFoundExceptionHandler {
	private static final Logger LOGGER = LogManager.getLogger(RoleNotFoundExceptionHandler.class);

	@ExceptionHandler(RoleNotFoundException.class)
	public ResponseEntity<Response<Object>> errorHAndler(RoleNotFoundException ex) {
		LOGGER.catching(ex);

...
public class InconsistentDataExceptionHandler {
	private static final Logger LOGGER = LogManager.getLogger(InconsistentDataExceptionHandler.class);

	@ExceptionHandler(InconsistentDataException.class)
	public ResponseEntity<Response<Object>> errorHAndler(InconsistentDataException ex) {
		LOGGER.catching(ex);

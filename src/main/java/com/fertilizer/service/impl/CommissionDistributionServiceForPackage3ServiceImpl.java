...
import com.fertilizer.repository.ProfitDistributionRepositoryForPackage3;
...
//@Service("commissionDistributionServiceForPackage3ServiceImpl")
@Service
public class CommissionDistributionServiceForPackage3ServiceImpl implements CommissionDistributionServiceForPackage1 {

	private static final Logger log = LoggerFactory
			.getLogger(CommissionDistributionServiceForPackage3ServiceImpl.class);

	@Autowired
	private ProfitDistributionRepositoryForPackage3 profitDistributionRepositoryForPackage3;
...
//	private String seminar;
	...
	public void distributeRegistrationFee(User newUser) {
		...
		List<ProfitDistributionMasterPackage3> profitDistributions = profitDistributionRepositoryForPackage3.findAll();
		...
		for (ProfitDistributionMasterPackage3 profitDistribution : profitDistributions) {
			if ("manufacturing".equals(profitDistribution.getCategoryId())) {
				...
				User manufacturingUser = userRepository.findByEmail("happyhomemanufacturing5k@gmail.com")
	...
	private void distributeRemainingToOtherUsers(List<String> emails, Map<String, BigDecimal> distributionMap) {
		...
		for (User user : users) {
			...
			case "happyhomedeveloper5k@gmail.com":
				amount = distributionMap.get("developer");
				break;
			case "happyhomemedical5k@gmail.com":
				amount = distributionMap.get("medical");
				break;
			case "happyhomerewards5k@gmail.com":
				amount = distributionMap.get("rewards");
				break;
			case "happyhomecompany5k@gmail.com":
				amount = distributionMap.get("company");
				break;
			case "happyhomepremiumuser5k@gmail.com":
				amount = distributionMap.get("premiumuser");
				break;
			case "happyhometraveluser5k@gmail.com":
				amount = distributionMap.get("travel");
				break;
			case "happyhomebikeuser5k@gmail.com":
				amount = distributionMap.get("bike");
				break;
			case "happyhomecaruser5k@gmail.com":
				amount = distributionMap.get("car");
				break;
			case "happyhomehouseuser5k@gmail.com":
				amount = distributionMap.get("house");
				break;
			case "happyhomehealthuser5k@gmail.com":
				amount = distributionMap.get("health");
				break;
			case "happyhomeseminaruser5k@gmail.com":
